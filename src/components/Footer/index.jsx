...
const SOCIAL_LINKS = [
  ...
  {
    label: 'Email',
    href: 'mailto:abirnibir10@gmail.com',
    icon: (
  ...
  const handleCapture = async (e) => {
    ...
    try {
      const res = await fetch(FORMSPREE_ENDPOINT, {
        ...
        body: JSON.stringify({
          email,
          subject: 'Footer quick contact',
          message: `Quick "let's build something" signup from the footer — reply to ${email}.`,
        }),
      });
      if (res.ok) {
        setSent(true);
      ...
      setError('Something went wrong — try the contact page instead.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="footer-grid">
          <div className="footer-brand-col">
            <div className="footer-brand">
              <div className="footer-logo-mark"><img src="/logo.png" alt="Logo" /></div>
              <div>
                <p className="footer-brand-name">Nibir Abeer</p>
                <p className="footer-brand-sub">Frontend &amp; Full-Stack Developer</p>
              </div>
            </div>
            ...
            <div className="footer-capture">
              ...
              {sent ? (
                ...
                <form className="footer-capture-form" onSubmit={handleCapture}>
                  ...
                  />
                  <button type="submit" className="footer-capture-submit" disabled={loading} aria-label="Send">
              ...
              {error && <p className="footer-capture-error">{error}</p>}
            </div>
          </div>

          <div className="footer-links-grid">
            <div className="footer-link-col">
              <p className="footer-link-heading">Pages</p>
              {PAGE_LINKS.map((l) => (
            ...
            <div className="footer-link-col">
              <p className="footer-link-heading">Connect</p>
